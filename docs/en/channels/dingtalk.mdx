...
```json
{
  ...
  "dingtalk_reply_mode": "stream_card"
}
```

`dingtalk_reply_mode` supports:

- `stream_card`: default, replies with streaming AI Markdown cards
- `normal`: replies with regular text/image/file messages
